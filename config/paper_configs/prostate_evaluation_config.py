...
_EMBEDDINGS_DIR = _DATA_DIR / "embeddings_prostate"
...
STRUCTURED_FILE_PATH = str(_DATA_DIR / "baseline_features.csv")

# Label column name
LABEL_COL = 'BF'  # Biological failure
...
ADDITIONAL_FEATURES = {
    'CFG': str(_DATA_DIR / "stanford_oncology_CFG.csv"),
    'CLFG': str(_DATA_DIR / "clfg.csv")
    # Example:
...
INNER_CV_REPEATS = 5  # Number of repeats for inner CV (RepeatedStratifiedKFold)
...
TARGET_DIMS = [30, 60, 90, 120]

# ============================================================================
# Imputation Configuration
# ============================================================================

# Imputation method: 'median', 'mice', 'svd', or 'knn'
...
MODELS = {
    ...
    'RandomFeature': {
        ...
        'param_grid': {
            'n_components': [64, 128, 256, 512],  # Properly reduced for small dataset (147 samples, ~98 in training)
    ...
    'KNN': {
        ...
        'params': {},
        'param_grid': {
            'n_neighbors': [5, 7, 9, 11, 13],  # Appropriate for 147 samples
...
MODELS_FOR_SELECTION = {
    ...
    'RandomFeature': {
        'class': 'core.ml_models.RandomFeatureModel',
        'params': {
            'random_state': None  # Will be set per iteration
        },
        'param_grid': {
            'n_components': [50, 100, 200, 500],
...
PERMUTATION_TEST_PAIRS = [
    ...
    #('Baseline + CFG', 'Baseline + SNOW'),
    #('Baseline + SNOW', 'Baseline + CFG'),
    #('Baseline + BoW TF-IDF', 'Baseline + SNOW'),
    #('Baseline + BoW TF-IDF', 'Baseline + CFG'),
    #('Baseline + CFG', 'Baseline + BoW TF-IDF'),
